...
public class Pokerito {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 5; i++) {
            String pressedKey = scan.nextLine();
            while (!pressedKey.isEmpty()) {
                pressedKey = scan.nextLine();
            ...
            if (playerCard.equals(card) && card.equals(card)) {
                yourMatches++;
                computerMatches++;
            } else if (playerCard.equals(card)) {
                yourMatches++;
